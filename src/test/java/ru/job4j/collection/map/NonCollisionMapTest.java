...
import ru.job4j.collection.map.NonCollisionMap;
...
class NonCollisionMapTest {
    ...
    void whenPutAndRemove() {
        ...
        assertThat(map).hasSize(3).containsExactly(null, 1, 3);
        assertThat(map.remove(3)).isTrue();
        assertThat(map).hasSize(2).containsExactly(null, 1);
    ...
    void whenPutAndGet() {
        ...
        assertThat(map.get(2)).isEqualTo(null);
    }
}
